...
function Disclaimer() {
  ...
  return (
    <div className="bg-white p-8 rounded-lg w-full text-sm">
      <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 flex sm:items-center gap-2">
        <span role="img" aria-label="scroll">📜</span>
        Disclaimer &amp; Affiliate Disclosure for ExploreIndiaView
      </h1>
      ...
      <h2 className="text-xl font-semibold text-gray-700 mt-8 mb-3 flex sm:items-center gap-2">
